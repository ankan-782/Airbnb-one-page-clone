...
export default function LanguageChangeSection() {
    return (
        <>
            <article className="py-8 flex gap-3">
                <div>
                ...
                <div>
                    <p className="text-sm tablet:text-base">Some info has been automatically translated.
                        <span className="ml-1">
                            <button type="button" className="underline font-semibold">Show original language</button>
                        </span>
                    </p>
                </div>
            </article>
