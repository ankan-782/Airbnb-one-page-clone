export default function SecondaryFooter() {
    return (
        <footer aria-label="secondary-footer" className="bg-neutral-200">
            <div className="container tablet:px-10 laptop:px-20 | py-6 text-sm laptop:border-t laptop:border-solid laptop:border-neutral-600/20">
                <div className="laptop:flex laptop:items-center laptop:justify-between max-laptop:space-y-4">
                    <div className="flex items-center tablet:justify-center space-x-10 laptop:space-x-4 laptop:order-last">
                        <div className="flex items-center font-semibold">
                            <button type="button" className="flex items-center justify-between space-x-2 space-x-reverse mr-3">
                                <span className="hidden">Choose a language</span>
                                <span>
                            ...
                            <button type="button" className="flex items-center justify-between space-x-2 space-x-reverse">
                                <span className="hidden">Choose a currency</span>
                                <span>$</span>
                                <a href="#" className="hover:underline">USD</a>
                            </button>
                        </div>
                        <ul className="hidden tablet:flex space-x-4">
                            <li>
                                <a href="#">
                    ...
                    <div className="laptop:flex">
                        <p className="tablet:text-center laptop:mr-2">© {new Date().getFullYear()} Airbnb, Inc.</p>
                        <div className="flex items-center tablet:justify-center">
                            <ol aria-label="footer-navigation" className="flex flex-wrap items-center space-x-2">
                                <li>
                                    <span className="mr-2 max-laptop:hidden">·</span>
